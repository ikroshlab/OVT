...
public class NativeBufferPool extends Pool<BufferItem> {
	...
	@Override
	protected BufferItem createItem() {		// unused;
		return null;
	}
	...
	public BufferItem get(int size) {
		...
		if (b.size < size)	b.growBuffer(size);
	...
	// handling Logging:
	private static void logDebug(String msg) { Log.d("VTM", " ### " + "NativeBufferPool" + " ###  " + msg); }
}
