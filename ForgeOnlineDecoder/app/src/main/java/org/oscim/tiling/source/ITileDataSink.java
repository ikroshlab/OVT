...
// todo: as this interface uses MapElement extended from the GeometryBuffer which now has additional
// todo: methods getTypeInt() and setTypeInt(int), and also the field "int pointLimit" (depricated?),-
// todo: it will surely conflict with the original one.
// todo: So, some corrections must be done.....
