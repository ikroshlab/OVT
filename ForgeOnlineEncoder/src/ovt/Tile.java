 ...
 * All tiles can be identified by their X and Y number together with their zoom level.
 * The actual area that a tile covers on a map depends on the underlying map projection.
 */
public class Tile {
	...
	public boolean equals(Object obj) {
		...
		if (o.tileX == this.tileX && o.tileY == this.tileY && o.zoomLevel == this.zoomLevel)  return true;
