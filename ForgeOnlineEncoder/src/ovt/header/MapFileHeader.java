...
public class MapFileHeader {
	...
	public byte getQueryZoomLevel(byte zoomLevel) {
		if      (zoomLevel > this.zoomLevelMaximum)  return this.zoomLevelMaximum;
		else if (zoomLevel < this.zoomLevelMinimum)  return this.zoomLevelMinimum;
	...
	private OpenResult readSubFileParameters(ReadBuffer readBuffer, long fileSize, MapFileInfoBuilder mapFileInfoBuilder) {
