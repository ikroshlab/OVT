...
import ovt.header.MapFileHeader;
...
public class MapFileTileSource extends TileSource {
    ...
    private static final int    INDEX_CACHE_SIZE = 64;  // Amount of cache blocks that the index cache should store.
    ...
    public OpenResult open() {
        if (!options.containsKey("file")) return new OpenResult("no map file set");
